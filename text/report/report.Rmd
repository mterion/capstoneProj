...
* The training / testing procedure is the following:
    ...
    + Both models one 1000 random samples selected from test set
    + Speed and accuracy are registered
    + A new train sample is randomly selected by adding the step of 10'000 to the size of the preceding sample
